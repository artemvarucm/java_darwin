...
import es.ucm.factories.IndividuoHormigaArbolFactory;
...
public class SubtreeSwapCrossTest extends AbstractCrossTest {
    ...
    public void crossTest1() {
        IndividuoFactory factory = new IndividuoHormigaArbolFactory(new SantaFeMap(), 400, 0., new FULLInitializer(3));
